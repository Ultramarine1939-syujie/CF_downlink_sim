...
function printFinalResults(ESR_MR_all, ESR_L_all, ESR_R_all, ESR_PSO_MR_all, ESR_PSO_L_all, ESR_PSO_R_all, ...
    ...
    fprintf('╠══════════════════════════════════════════════════════════════════════════════════════════╣\n');
    fprintf('║  Performance Summary (Min ESR ~ Max ESR over SNR range):                                 ║\n');
    fprintf('║  ┌──────────────────────────────────────────────────────────────────────────────────┐ ║\n');
    fprintf('║  │ Algorithm           │ Mode   │ Min ESR        │ Max ESR        │                 │ ║\n');
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ MR                  │ All-UE │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_MR_all), max(ESR_MR_all));
    fprintf('║  │ Random+MR           │ All-UE │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_MR_all), max(ESR_Random_MR_all));
    fprintf('║  │ PSO+MR             │ All-UE │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_MR_all), max(ESR_PSO_MR_all));
    fprintf('║  │ EPA+MR             │ All-UE │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_MR_all), max(ESR_EPA_MR_all));
    fprintf('║  │ WMMSE+MR          │ All-UE │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_MR_all), max(ESR_WMMSE_MR_all));
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ L-MMSE             │ All-UE │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_L_all), max(ESR_L_all));
    fprintf('║  │ Random+L-MMSE      │ All-UE │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_L_all), max(ESR_Random_L_all));
    fprintf('║  │ PSO+L-MMSE         │ All-UE │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_L_all), max(ESR_PSO_L_all));
    fprintf('║  │ EPA+L-MMSE         │ All-UE │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_L_all), max(ESR_EPA_L_all));
    fprintf('║  │ WMMSE+L-MMSE      │ All-UE │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_L_all), max(ESR_WMMSE_L_all));
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ Robust-MMSE        │ All-UE │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_R_all), max(ESR_R_all));
    fprintf('║  │ Random+R-MMSE      │ All-UE │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_R_all), max(ESR_Random_R_all));
    fprintf('║  │ PSO+R-MMSE         │ All-UE │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_R_all), max(ESR_PSO_R_all));
    fprintf('║  │ EPA+R-MMSE         │ All-UE │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_R_all), max(ESR_EPA_R_all));
    fprintf('║  │ WMMSE+R-MMSE      │ All-UE │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_R_all), max(ESR_WMMSE_R_all));
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ MR                  │ DCC    │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_MR_dcc), max(ESR_MR_dcc));
    fprintf('║  │ Random+MR           │ DCC    │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_MR_dcc), max(ESR_Random_MR_dcc));
    fprintf('║  │ PSO+MR             │ DCC    │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_MR_dcc), max(ESR_PSO_MR_dcc));
    fprintf('║  │ EPA+MR             │ DCC    │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_MR_dcc), max(ESR_EPA_MR_dcc));
    fprintf('║  │ WMMSE+MR          │ DCC    │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_MR_dcc), max(ESR_WMMSE_MR_dcc));
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ L-MMSE             │ DCC    │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_L_dcc), max(ESR_L_dcc));
    fprintf('║  │ Random+L-MMSE      │ DCC    │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_L_dcc), max(ESR_Random_L_dcc));
    fprintf('║  │ PSO+L-MMSE         │ DCC    │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_L_dcc), max(ESR_PSO_L_dcc));
    fprintf('║  │ EPA+L-MMSE         │ DCC    │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_L_dcc), max(ESR_EPA_L_dcc));
    fprintf('║  │ WMMSE+L-MMSE      │ DCC    │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_L_dcc), max(ESR_WMMSE_L_dcc));
    fprintf('║  ├─────────────────────┼────────┼────────────────┼────────────────┼─────────────────┤ ║\n');
    fprintf('║  │ Robust-MMSE        │ DCC    │ %8.2f       │ %8.2f       │ (Baseline)      │ ║\n', min(ESR_R_dcc), max(ESR_R_dcc));
    fprintf('║  │ Random+R-MMSE      │ DCC    │ %8.2f       │ %8.2f       │ (Control)       │ ║\n', min(ESR_Random_R_dcc), max(ESR_Random_R_dcc));
    fprintf('║  │ PSO+R-MMSE         │ DCC    │ %8.2f       │ %8.2f       │ (PSO)           │ ║\n', min(ESR_PSO_R_dcc), max(ESR_PSO_R_dcc));
    fprintf('║  │ EPA+R-MMSE         │ DCC    │ %8.2f       │ %8.2f       │ (EPA)           │ ║\n', min(ESR_EPA_R_dcc), max(ESR_EPA_R_dcc));
    fprintf('║  │ WMMSE+R-MMSE      │ DCC    │ %8.2f       │ %8.2f       │ (WMMSE)         │ ║\n', min(ESR_WMMSE_R_dcc), max(ESR_WMMSE_R_dcc));
    fprintf('║  └──────────────────────────────────────────────────────────────────────────────────┘ ║\n');
